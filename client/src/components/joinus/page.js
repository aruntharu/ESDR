...
const JoinUs = () => {
  ...
  return (
    <div
      className="bg-[#83b4c1] py-10 px-4 flex flex-col items-center"
      data-aos="fade-up"
      data-aos-delay="300"
    >
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-white text-center mb-6">Join Us</h2>
        <p className="text-xl font-bold text-white text-center mb-8">
          We invite scholars, practitioners, activists, and anyone interested in
          the intersection of law, justice, and decolonization to join us for
          the 16th ESDR Program. Together, we can envision and work towards a
          future where legal systems are truly just, equitable, and reflective
          of the diverse societies they serve. We look forward to your
          participation in this vital conversation.
        </p>
      </div>
      <div className="max-w-6xl w-full flex flex-col md:flex-row items-center justify-center">
        <h2 className="text-3xl font-bold text-white mb-4 md:mb-0 md:mr-4">
      ...
      {submitted && (
        <p className="text-center text-white mt-4">
          Thank you! You will receive the latest information about ESDR in your
          email.
        </p>
      )}
    </div>
